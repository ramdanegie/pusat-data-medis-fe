define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('TindakanAnestesiUmumCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            // })
            medifirstService.getPart2('7105','emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
                                $scope.item.objcbo[data.options.idididid] = data
                            })
             medifirstService.getPart2('7106','emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
                                $scope.item.objcbo[data.options.idididid] = data
                            })
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Tindakan Anestesi Umum Informed Consent' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '
