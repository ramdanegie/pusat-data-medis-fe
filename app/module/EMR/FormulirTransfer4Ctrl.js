define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 319).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 400253, "nama": "IGD", "type": "checkbox" },
                        { "id": 400254, "nama": "IRJ", "type": "checkbox" },
                        { "id": 400255, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 400256, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 400283, "nama": "Ada", "type": "checkbox" },
                        { "id": 400284, "nama": "Tidak", "type": "checkbox" },
                        { "id": 400285, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 400286, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 400258, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 400259, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 400260, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 400261, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 400262, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 400263, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[400294]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
