define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer21Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 398).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 108884, "nama": "IGD", "type": "checkbox" },
                        { "id": 108885, "nama": "IRJ", "type": "checkbox" },
                        { "id": 108886, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 108887, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 108914, "nama": "Ada", "type": "checkbox" },
                        { "id": 108915, "nama": "Tidak", "type": "checkbox" },
                        { "id": 108916, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 108917, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 108889, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 108890, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 108891, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 108892, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 108893, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 108894, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[108925]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
