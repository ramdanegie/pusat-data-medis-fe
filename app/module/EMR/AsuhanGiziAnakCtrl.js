define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsuhanGiziAnakCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 230).then(function (e) {
            ...
            $scope.listAsesmenGizi = [
                {
                    ...
                    "detail": [
                        { "id": 15395, "nama": "BB", "type": "textbox" },
                        { "id": 15396, "nama": "TB", "type": "textbox" },
                        { "id": 15397, "nama": "IMT", "type": "textbox" },
                        { "id": 15398, "nama": "LLA", "type": "textbox" },
                        { "id": 15399, "nama": "LK", "type": "textbox" },
                        { "id": 15400, "nama": "BB ideal", "type": "textbox" },
                        { "id": 15401, "nama": "BB/U", "type": "textbox" },
                        { "id": 15402, "nama": "TB/U", "type": "textbox" },
                        { "id": 15403, "nama": "BB/TB", "type": "textbox" },
                        { "id": 15404, "nama": "LLA/U", "type": "textbox" },
            ...
            $scope.listPola = [
                {
                    "id": 1, "nama": "Pola Makan",
                    "detail": [
                        { "id": 15424, "nama": "", "type": "textarea" },
