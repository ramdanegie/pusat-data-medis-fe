define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PemesananMakanan2Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 365).then(function (e) {
            ...
            $scope.listPesanan = [
                {
                    ...
                    "detail": [
                        { "id": 8172, "nama": "1. Nasi", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 8173, "nama": "2. Nasi Tim", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 8174, "nama": "3. Bubur", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 8175, "nama": "4. Bubur Tim", "type": "checkbox" },
                    ]
                },
                {
