define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer8Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 333).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 401362, "nama": "IGD", "type": "checkbox" },
                        { "id": 401363, "nama": "IRJ", "type": "checkbox" },
                        { "id": 401364, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 401365, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 401392, "nama": "Ada", "type": "checkbox" },
                        { "id": 401393, "nama": "Tidak", "type": "checkbox" },
                        { "id": 401394, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 401395, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 401367, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 401368, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 401369, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 401370, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 401371, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 401372, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[401403]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
