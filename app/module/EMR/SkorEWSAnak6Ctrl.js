define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSAnak6Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 370).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[62889] = $scope.skor1
                $scope.item.obj[62890] = $scope.skor2
                $scope.item.obj[62891] = $scope.skor3
                $scope.item.obj[62892] = $scope.skor4
                $scope.item.obj[62893] = $scope.skor5
                $scope.item.obj[62894] = $scope.skor6
                $scope.item.obj[62895] = $scope.skor7
                $scope.item.obj[62896] = $scope.skor8
                $scope.item.obj[62897] = $scope.skor9
                $scope.item.obj[62898] = $scope.skor10
                $scope.item.obj[62899] = $scope.skor11
                $scope.item.obj[62900] = $scope.skor12
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Anak 6 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
