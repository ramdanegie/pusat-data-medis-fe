define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenRisikoMelarikanDiri6Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 272).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[68654]=$scope.cc.tglregistrasi
                $scope.item.obj[68656]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
                $scope.item.obj[68655]={value: $scope.cc.objectruanganfk, text : $scope.cc.namaruangan}
                ...
                medifirstService.get("emr/get-nilai-statis-igd?noregistrasi=" + $scope.cc.noregistrasi + "&objectidawal=3095&objectidakhir=3121&idemr=125", true).then(function (datas) {
                    if (datas.data.data.length>0){
                        $scope.item.obj[69151]=datas.data.data[0].nilai
                    }
                })
            ...
            $scope.listRisikoJatuhSkor = [
                { id: 69223, nama: 'Rendah ( < 7 )' },
                { id: 69224, nama: 'Sedang ( 7 - 14 )' },
                { id: 69225, nama: 'Tinggi ( > 14 )' },
            ]
