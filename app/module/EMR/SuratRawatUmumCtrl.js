define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SuratRawatUmumCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listNamaEdukasi = [
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 113060, "nama": "Akut", "type": "checkbox" },
                        { "id": 113061, "nama": "Sub Akut", "type": "checkbox" },
                        { "id": 113062, "nama": "Psikogeriatri", "type": "checkbox" },
                        { "id": 113063, "nama": "Rehabilitasi Napza ", "type": "checkbox" },
                        { "id": 113064, "nama": "Ruang perawatan fisik", "type": "checkbox" },
                        { "id": 113065, "nama": "", "type": "textbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[113052] = $scope.now
                $scope.item.obj[113056] = new Date ($scope.cc.tgllahir) 
                $scope.item.obj[113054] = $scope.cc.namapasien
                $scope.item.obj[113055] = $scope.cc.nocm
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Surat Permintaan Rawat Inap umum ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
