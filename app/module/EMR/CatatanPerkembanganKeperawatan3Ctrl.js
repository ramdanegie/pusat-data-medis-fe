define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CatatanPerkembanganKeperawatan3Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 329).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[400986] = { value: $scope.cc.iddpjp , text:  $scope.cc.dokterdpjp }
                $scope.item.obj[400987] = { value: $scope.cc.objectruanganfk , text:  $scope.cc.namaruangan }
                $scope.item.obj[400988] = { value: $scope.cc.objectkelasfk , text:  $scope.cc.namakelas }
