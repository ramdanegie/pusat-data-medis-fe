define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LembarObservasiPxDenganRestrain3Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-restrain&id='
                 + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true' + '&idemr=' + 290  , function (response) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 290).then(function (e) {
