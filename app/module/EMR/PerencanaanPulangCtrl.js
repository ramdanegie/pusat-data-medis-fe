...
define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PerencanaanPulangCtrl', ['$timeout', '$q', '$rootScope', '$scope', '$state', 'MedifirstService',
        function ($timeout, $q, $rootScope, $scope, $state, medifirstService) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-data-rekam-medis', jsonSave).then(function (e) {
                    $scope.item = {};
                    $scope.getdata();
                    medifirstService.postLogging('Pengkajian Keperawatan', 'Norec Antrian Pasien Diperiksa', $state.params.noRec, 'Perencanaan Pulang').then(function (res) {
                    })
                });
            }
        }
