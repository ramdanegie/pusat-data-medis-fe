define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PemesananMakanan4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 367).then(function (e) {
            ...
            $scope.listPesanan = [
                {
                    ...
                    "detail": [
                        { "id": 405660, "nama": "1. Nasi", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 405661, "nama": "2. Nasi Tim", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 405662, "nama": "3. Bubur", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 405663, "nama": "4. Bubur Tim", "type": "checkbox" },
                    ]
                },
                {
