define(['initialize'], function(initialize) {
    ...
    initialize.controller('SkriningKekhususanTambahanRevCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService','DateHelper',
        function($q, $rootScope, $scope, $state, cacheHelper, medifirstService, dateHelper) {
