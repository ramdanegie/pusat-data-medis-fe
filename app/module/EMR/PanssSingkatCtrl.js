define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PanssSingkatCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-pans&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true', function (response) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 142).then(function (e) {
                ...
                for (let i = 0; i < datas.length; i++) {
                    ...
                    // ARRAY GEJALA 
                    if (element.kodeexternal == 'negatif') {
            ...
            if (chacePeriode != undefined) {
                ...
                medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                    $scope.item.obj = []
                    $scope.item.obj2 = []
                    $scope.item.obj[10311]=$scope.now
                    $scope.item.obj[300002]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
