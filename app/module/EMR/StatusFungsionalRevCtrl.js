define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('StatusFungsionalRevCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state',  'CacheHelper', 'MedifirstService',
            ...
            $scope.Save = function () {
                ...
                var jsonSave = {
             	...
             	medifirstService.post('emr/save-data-rekam-medis', jsonSave).then(function (e) {
                    $scope.arrParameterRawatInap = [];
                    $scope.getdata();
                    medifirstService.postLogging('Pengkajian Keperawatan', 'Norec Antrian Pasien Diperiksa', $state.params.noRec, 'Status Fungsional').then(function (res) {
                    })
                });
            }
        }
