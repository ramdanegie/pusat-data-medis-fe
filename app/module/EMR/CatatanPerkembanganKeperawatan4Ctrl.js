define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CatatanPerkembanganKeperawatan4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 330).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[401153] = { value: $scope.cc.iddpjp , text:  $scope.cc.dokterdpjp }
                $scope.item.obj[401154] = { value: $scope.cc.objectruanganfk , text:  $scope.cc.namaruangan }
                $scope.item.obj[401155] = { value: $scope.cc.objectkelasfk , text:  $scope.cc.namakelas }
