define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer24Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 401).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109013, "nama": "IGD", "type": "checkbox" },
                        { "id": 109014, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109015, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109016, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109043, "nama": "Ada", "type": "checkbox" },
                        { "id": 109044, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109045, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109046, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109018, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109019, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109020, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109021, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109022, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109023, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109054]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 24' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
