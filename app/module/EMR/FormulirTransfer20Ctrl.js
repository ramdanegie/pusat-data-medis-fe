define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer20Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 397).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 108841, "nama": "IGD", "type": "checkbox" },
                        { "id": 108842, "nama": "IRJ", "type": "checkbox" },
                        { "id": 108843, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 108844, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 108871, "nama": "Ada", "type": "checkbox" },
                        { "id": 108872, "nama": "Tidak", "type": "checkbox" },
                        { "id": 108873, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 108874, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 108846, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 108847, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 108848, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 108849, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 108850, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 108851, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[108882]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 26' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
