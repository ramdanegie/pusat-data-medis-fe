define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SuratRawatCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 224).then(function (e) {
            ...
            $scope.listNamaEdukasi = [
                {
                    ...
                    "detail": [
                        { "id": 15694, "nama": "", "type": "textbox" },
                        
                        
                    ]
                },
                {
                    "id": 2, "nama": "No. Rekam Medis :",
                    "detail": [
                        { "id": 15695, "nama": "", "type": "textbox" },
                        
                        
                    ]
                },
                {
                    "id": 3, "nama": "Tanggal lahir :",
                    "detail": [
                        { "id": 15696, "nama": "", "type": "datetime" },
                ...
                },
                {
                    "id": 4, "nama": "Diagnosa :",
                    "detail": [
                        { "id": 15697, "nama": "", "type": "Combodiag" },
                        
                        
                    ]
                },
                {
                    "id": 5, "nama": "Dokter yang merawat/DPJP :",
                    "detail": [
                        { "id": 15698, "nama": "", "type": "combodok" },
                        
                        
                    ]
                },
                {
                    "id": 6, "nama": "Indikasi/Sebab dirawat :",
                    "detail": [
                        { "id": 15699, "nama": "", "type": "textbox" },
                        
                        
                    ]
                },
                {
                    "id": 7, "nama": "Pasien memerlukan ruang perawatan ",
                    "detail": [
                        { "id": 15700, "nama": "Akut", "type": "checkbox" },
                        { "id": 15701, "nama": "Sub Akut", "type": "checkbox" },
                        { "id": 15702, "nama": "Psikogeriatri", "type": "checkbox" },
                        { "id": 15703, "nama": "Rehabilitasi Napza ", "type": "checkbox" },
                        { "id": 15704, "nama": "Ruang perawatan fisik", "type": "checkbox" },
                        { "id": 15705, "nama": "", "type": "textbox" },
