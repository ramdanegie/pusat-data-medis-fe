define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer18Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 343).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 401792, "nama": "IGD", "type": "checkbox" },
                        { "id": 401793, "nama": "IRJ", "type": "checkbox" },
                        { "id": 401794, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 401795, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 401822, "nama": "Ada", "type": "checkbox" },
                        { "id": 401823, "nama": "Tidak", "type": "checkbox" },
                        { "id": 401824, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 401825, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 401797, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 401798, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 401799, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 401800, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 401801, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 401802, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[401833]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
