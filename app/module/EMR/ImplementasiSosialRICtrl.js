define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ImplementasiSosialRICtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 184).then(function (e) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Implementasi Keperawatan Isolasi Sosial ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
