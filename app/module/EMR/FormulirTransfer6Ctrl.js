define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer6Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 321).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 400339, "nama": "IGD", "type": "checkbox" },
                        { "id": 400340, "nama": "IRJ", "type": "checkbox" },
                        { "id": 400341, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 400342, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 400369, "nama": "Ada", "type": "checkbox" },
                        { "id": 400370, "nama": "Tidak", "type": "checkbox" },
                        { "id": 400371, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 400372, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 400344, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 400345, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 400346, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 400347, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 400348, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 400349, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[400380]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
