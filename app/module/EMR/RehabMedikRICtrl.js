define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RehabMedikRICtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
           ...
           medifirstService.getPart('emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 128).then(function (e) {
            ...
            $scope.listNamaEdukasi = [
                {
                    ...
                    "detail": [
                        { "id": 101467, "nama": "Autoanamnesis", "type": "checkbox" },
                        { "id": 101468, "nama": "Alonamnesis", "type": "checkbox" },
                        { "id": 101469, "nama": "Keluhan Utama", "type": "textarea" },
                        { "id": 101470, "nama": "Riwayat Penyakit Sekarang", "type": "textarea" },
                        { "id": 101471, "nama": "Riwayat Penyakit Dahulu", "type": "textarea" },
                        { "id": 101472, "nama": "Riwayat Tumbuh Kembang(Khusus pasien Anak)", "type": "textarea" },
                        { "id": 101473, "nama": "Riwayat Nutrisi(Khusus pasien Anak)", "type": "textarea" },
             ...
             $scope.listPemeriksaanFisik = [
                {
                    ...
                    "detail": [
                        { "id": 101476, "satuan" : "mmHg", "nama": "Tekanan Darah :", "type": "textbox" },
                        { "id": 101477, "satuan" : "x/menit", "nama": "Nadi :", "type": "textbox" },
                        { "id": 101478, "satuan" : "x/menit", "nama": "Pernapasan :", "type": "textbox" },
                        { "id": 101479, "satuan" : "°C", "nama": "Temperatur :", "type": "textbox" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 101481, "nama": "Tidak Ada", "type": "checkbox" },
                        { "id": 101482, "nama": "Ada,Lokasi", "type": "checkboxtextbox" },
                        { "id": 101483, "nama": "Skala VAS :", "type": "textbox" },
                        { "id": 101484, "nama": "Status Internus", "type": "textarea" },
                        { "id": 101485, "nama": "Riwayat Neurologis", "type": "textarea" },
                        { "id": 101486, "nama": "Reflex Primitif(khusus pasien Anak)", "type": "textarea" },
                        { "id": 101487, "nama": "Test Khusus", "type": "textarea" },
                        { "id": 101488, "nama": "Status Lokasis", "type": "textarea" },
             ...
             $scope.listPemeriksaanFisik2 = [
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 101646, "nama": "Diagnosa Klinis", "type": "textarea" },
                        { "id": 101647, "nama": "Diagnosa Fungsional", "type": "textarea" },
                        { "id": 101648, "nama": "Problem Rehabilitasi Medik", "type": "textarea" },
                        { "id": 101649, "nama": "Program Rehabilitasi Medik", "type": "textarea" },
