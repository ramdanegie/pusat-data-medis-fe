define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer22Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 399).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 108927, "nama": "IGD", "type": "checkbox" },
                        { "id": 108928, "nama": "IRJ", "type": "checkbox" },
                        { "id": 108929, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 108930, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 108957, "nama": "Ada", "type": "checkbox" },
                        { "id": 108958, "nama": "Tidak", "type": "checkbox" },
                        { "id": 108959, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 108960, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 108932, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 108933, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 108934, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 108935, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 108936, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 108937, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[108968]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
