define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer19Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 396).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 108798, "nama": "IGD", "type": "checkbox" },
                        { "id": 108799, "nama": "IRJ", "type": "checkbox" },
                        { "id": 108800, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 108801, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 108828, "nama": "Ada", "type": "checkbox" },
                        { "id": 108829, "nama": "Tidak", "type": "checkbox" },
                        { "id": 108830, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 108831, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 108803, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 108804, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 108805, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 108806, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 108807, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 108808, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[108839]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 25' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
