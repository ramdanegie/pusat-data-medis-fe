define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransferUmumCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 462).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 113350, "nama": "IGD", "type": "checkbox" },
                        { "id": 113351, "nama": "IRJ", "type": "checkbox" },
                        { "id": 113352, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 113353, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 113380, "nama": "Ada", "type": "checkbox" },
                        { "id": 113381, "nama": "Tidak", "type": "checkbox" },
                        { "id": 113382, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 113383, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 113355, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 113356, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 113357, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 113358, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 113359, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 113360, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[113391]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer umum ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
