define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer27Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 406).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109285, "nama": "IGD", "type": "checkbox" },
                        { "id": 109286, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109287, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109288, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109315, "nama": "Ada", "type": "checkbox" },
                        { "id": 109316, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109317, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109318, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109290, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109291, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109292, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109293, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109294, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109295, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109326]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 27' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
