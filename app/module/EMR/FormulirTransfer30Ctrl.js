define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer30Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 409).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109414, "nama": "IGD", "type": "checkbox" },
                        { "id": 109415, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109416, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109417, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109444, "nama": "Ada", "type": "checkbox" },
                        { "id": 109445, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109446, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109447, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109419, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109420, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109421, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109422, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109423, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109424, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109455]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 30' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
