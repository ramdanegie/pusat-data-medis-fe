define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ImplementasiBunuhDiriCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 234).then(function (e) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Implementasi Rsiko Bunuh Diri' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '
