define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenRisikoBunuhDiri4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 276).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[70726]=$scope.cc.tglregistrasi
                $scope.item.obj[70728]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
                $scope.item.obj[70727]={value: $scope.cc.objectruanganfk, text : $scope.cc.namaruangan}
                ...
                medifirstService.get("emr/get-nilai-statis-igd?noregistrasi=" + $scope.cc.noregistrasi + "&objectidawal=2994&objectidakhir=3014&idemr=123", true).then(function (datas) {
                    if (datas.data.data.length>0){
                        $scope.item.obj[71115]=datas.data.data[0].nilai
                    }
                })
            ...
            $scope.listRisikoJatuhSkor = [
                { id: 71187, nama: 'Rendah ( < 7 )' },
                { id: 71188, nama: 'Sedang ( 7 - 14 )' },
                { id: 71189, nama: 'Tinggi ( > 14 )' },
            ]
