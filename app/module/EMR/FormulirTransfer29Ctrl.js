define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer29Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 408).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109371, "nama": "IGD", "type": "checkbox" },
                        { "id": 109372, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109373, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109374, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109401, "nama": "Ada", "type": "checkbox" },
                        { "id": 109402, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109403, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109404, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109376, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109377, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109378, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109379, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109380, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109381, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109412]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 29' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
