define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RehabMedikRjCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
           ...
           medifirstService.getPart('emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 129).then(function (e) {
            ...
            $scope.listNamaEdukasi = [
                {
                    "id": 1, "nama": "Anammnesis :",
                    "detail": [
                        { "id": 101657, "nama": "Autoanamnesis", "type": "checkbox" },
                        { "id": 101658, "nama": "Alonamnesis", "type": "checkbox" },
                        { "id": 101659, "nama": "Keluhan Utama", "type": "textarea" },
                        { "id": 101660, "nama": "Riwayat Penyakit Sekarang", "type": "textarea" },
                        { "id": 101661, "nama": "Riwayat Penyakit Dahulu", "type": "textarea" },
                        { "id": 101662, "nama": "Riwayat Tumbuh Kembang(Khusus pasien Anak)", "type": "textarea" },
                        { "id": 101663, "nama": "Riwayat Nutrisi(Khusus pasien Anak)", "type": "textarea" },
             ...
             $scope.listPemeriksaanFisik = [
                {
                    "id": 1, "nama": "Tanda-tanda Vital :",
                    "detail": [
                        { "id": 101664, "satuan" : "mmHg", "nama": "Tekanan Darah :", "type": "textbox" },
                        { "id": 101665, "satuan" : "x/menit", "nama": "Nadi :", "type": "textbox" },
                        { "id": 101666, "satuan" : "x/menit", "nama": "Pernapasan :", "type": "textbox" },
                        { "id": 101667, "satuan" : "°C", "nama": "Temperatur :", "type": "textbox" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 101668, "nama": "Tidak Ada", "type": "checkbox" },
                        { "id": 101669, "nama": "Ada,Lokasi", "type": "checkboxtextbox" },
                        { "id": 101670, "nama": "Skala VAS :", "type": "textbox" },
                        { "id": 101671, "nama": "Status Internus", "type": "textarea" },
                        { "id": 101672, "nama": "Riwayat Neurologis", "type": "textarea" },
                        { "id": 101673, "nama": "Reflex Primitif(khusus pasien Anak)", "type": "textarea" },
                        { "id": 101674, "nama": "Test Khusus", "type": "textarea" },
                        { "id": 101675, "nama": "Status Lokasis", "type": "textarea" },
                        
                    ]
                }
             ]
             $scope.listPemeriksaanFisik2 = [
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 101832, "nama": "Diagnosa Klinis", "type": "textarea" },
                        { "id": 101833, "nama": "Diagnosa Fungsional", "type": "textarea" },
                        { "id": 101834, "nama": "Problem Rehabilitasi Medik", "type": "textarea" },
                        { "id": 101835, "nama": "Program Rehabilitasi Medik", "type": "textarea" },
