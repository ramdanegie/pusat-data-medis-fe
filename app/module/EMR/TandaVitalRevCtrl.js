define(['initialize'], function (initialize) {
    ...
    initialize.controller('TandaVitalRevCtrl', ['$rootScope', '$scope', '$state', 'MedifirstService', 'CacheHelper',
        function ($rootScope, $scope, $state, medifirstService, cacheHelper) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-data-rekam-medis', jsonSave).then(function (e) {
                    $scope.getdataVital()
                    medifirstService.postLogging('Pengkajian Keperawatan', 'Norec Antrian Pasien Diperiksa', $state.params.noRec, 'Tanda Vital').then(function (res) {
                    })
                });
            };
        }
