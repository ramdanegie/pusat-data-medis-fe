define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('TindakanEctCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            // })
            medifirstService.getPart2('7087','emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
                                $scope.item.objcbo[data.options.idididid] = data
                            })
             medifirstService.getPart2('7088','emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
                                $scope.item.objcbo[data.options.idididid] = data
                            })
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Tindakan ECT Informed Consent' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '
