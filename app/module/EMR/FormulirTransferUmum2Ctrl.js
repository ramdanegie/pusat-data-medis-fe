define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransferUmum2Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 463).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 113393, "nama": "IGD", "type": "checkbox" },
                        { "id": 113394, "nama": "IRJ", "type": "checkbox" },
                        { "id": 113395, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 113396, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 113423, "nama": "Ada", "type": "checkbox" },
                        { "id": 113424, "nama": "Tidak", "type": "checkbox" },
                        { "id": 113425, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 113426, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 113398, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 113399, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 113400, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 113401, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 113402, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 113403, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[113434]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer umum 2' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
