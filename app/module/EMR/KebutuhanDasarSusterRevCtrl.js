...
define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('KebutuhanDasarSusterRevCtrl', ['$timeout','$q','$rootScope', '$scope', 'ModelItem', 'DateHelper', '$state','MedifirstService',
        function($timeout,$q,$rootScope, $scope, ModelItem, DateHelper, $state,medifirstService) {
            ...
            $scope.getdata=function(){
                ...
                var status = "t";
                medifirstService.get("emr/get-data-rekam-medis?noregistrasifk="+noregistrasifk+'&objectfk='+objectfk).then(function(e) {
            ...
            $scope.Save = function() {
                ...
                medifirstService.post('emr/save-data-rekam-medis', jsonSave).then(function (e) {
                    $scope.item={};
                    $scope.getdata();
                    medifirstService.postLogging('Pengkajian Keperawatan', 'Norec Antrian Pasien Diperiksa',$state.params.noRec, 'Pengkajian Kebutuhan Dasar').then(function (res) {
                    })
                });
            }
		}
