define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenRehabMedikCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 345).then(function (e) {
            ...
            $scope.listNamaEdukasi = [
                {
                    ...
                    "detail": [
                        { "id": 101177, "": "", "type": "textarea" },
                        
                        
                    ]
                },
                {
                    "id": 1, "nama": "II. Diagnosis Pengirim :",
                    "detail": [
                        { "id": 101178, "": "", "type": "textarea" },
             ...
             $scope.listpemeriksaan = [
                {
                    "id": 1, "nama": "A. Anamnesis(Auto Anamnesis / Hetero Anamnesis)",
                    "detail": [
                        { "id": 101179, "nama": "Keluhan utama", "type": "textarea" },
                        
                        
                    ]
                },
                {
                    "id": 2, "nama": "B. Pemeriksaan",
                    "detail": [
                        { "id": 101180, "nama": "1. Pemeriksaan Umum ( inspeksi, palpasi,perkusi, gerak dasar pasif/aktif, Auskultasi,kognitif, motarik halus, bahasa, artikulasi, bicara)", "type": "textarea" },
                        { "id": 101181, "nama": "2. Pemeriksaan spesifik", "type": "textarea" },
                        { "id": 101182, "nama": "3. Pemeriksaan Penunjang", "type": "textarea" },
            ...
            $scope.listDiagnosis = [
                {
                    "id": 1, "nama": "C. Diagnosis",
                    "detail": [
                        { "id": 101183, "nama": "FT", "type": "checkbox" },
                        { "id": 101184, "nama": "OT", "type": "checkbox" },
                        { "id": 101185, "nama": "TW", "type": "checkbox" },
                        { "id": 101186, "nama": "", "type": "textbox" },
                        { "id": 101187, "nama": "Keluhan utama", "type": "textarea" },
                ...
                {
                    "id": 2, "nama": "D. Intervensi",
                    "detail": [
                        { "id": 101188, "nama": "Keluhan utama", "type": "textarea" },
                ...
                },
                {
                    "id": 3, "nama": "E. Program",
                    "detail": [
                        { "id": 101189, "nama": "Keluhan utama", "type": "textarea" },
