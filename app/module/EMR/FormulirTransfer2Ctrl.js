define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer2Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 317).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 400163, "nama": "IGD", "type": "checkbox" },
                        { "id": 400164, "nama": "IRJ", "type": "checkbox" },
                        { "id": 400165, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 400166, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 400193, "nama": "Ada", "type": "checkbox" },
                        { "id": 400194, "nama": "Tidak", "type": "checkbox" },
                        { "id": 400195, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 400196, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 400168, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 400169, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 400170, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 400171, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 400172, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 400173, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[400204]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
