define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer23Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 400).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 108970, "nama": "IGD", "type": "checkbox" },
                        { "id": 108971, "nama": "IRJ", "type": "checkbox" },
                        { "id": 108972, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 108973, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109000, "nama": "Ada", "type": "checkbox" },
                        { "id": 109001, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109002, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109003, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 108975, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 108976, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 108977, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 108978, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 108979, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 108980, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109011]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 23' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
