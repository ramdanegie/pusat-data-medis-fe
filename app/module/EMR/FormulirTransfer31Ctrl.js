define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer31Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109457, "nama": "IGD", "type": "checkbox" },
                        { "id": 109458, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109459, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109460, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109487, "nama": "Ada", "type": "checkbox" },
                        { "id": 109488, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109489, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109490, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109462, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109463, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109464, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109465, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109466, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109467, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109498]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 31' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
