define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSAnak2Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 258).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[62262] = $scope.skor1
                $scope.item.obj[62263] = $scope.skor2
                $scope.item.obj[62264] = $scope.skor3
                $scope.item.obj[62265] = $scope.skor4
                $scope.item.obj[62266] = $scope.skor5
                $scope.item.obj[62267] = $scope.skor6
                $scope.item.obj[62268] = $scope.skor7
                $scope.item.obj[62269] = $scope.skor8
                $scope.item.obj[62270] = $scope.skor9
                $scope.item.obj[62271] = $scope.skor10
                $scope.item.obj[62272] = $scope.skor11
                $scope.item.obj[62273] = $scope.skor12
