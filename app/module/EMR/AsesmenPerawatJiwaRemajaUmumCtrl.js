define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenPerawatJiwaRemajaUmumCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 441).then(function (e) {
            ...
            $scope.listNyeri = [{
                ...
                "detail": [
                    { "id": 111135, "nama": "Tidak ", "type": "checkbox" },

                    { "id": 111136, "nama": "Ya ", "type": "checkbox" },
            ...
            $scope.listNyeri3 = [{
                "id": 1, "nama": "Jelaskan :",
                "detail": [
                    { "id": 111137, "nama": "Pencetus ", "type": "textbox" },

                    { "id": 111138, "nama": "Kualitas ", "type": "textbox" },
                    { "id": 111139, "nama": "Lokasi ", "type": "textbox" },
                    { "id": 111140, "nama": "Skala ", "type": "textbox" },
                    { "id": 111141, "nama": "Durasi ", "type": "textbox" },
            ...
            $scope.listSkorNRC = [{
                "id": 8, "nama": "Score ",
                "detail": [
                    { "id": 111157, "nama": "0= Tidak Nyeri", "type": "checkbox" },
                    { "id": 111158, "nama": "1 - 3= Nyeri Ringan", "type": "checkbox"},
                    { "id": 111159, "nama": "4 - 6= Nyeri Sedang", "type": "checkbox" },
                    { "id": 111160, "nama": "7 - 10= Nyeri Berat", "type": "checkbox"},
                ]
            }]
            $scope.listSkorWong = [{
                "id": 9, "nama": "Score ",
                "detail": [
                    { "id": 111167, "nama": "0 - 1= Tidak Ada Nyeri", "type": "checkbox"},
                    { "id": 111168, "nama": "2 - 3= Sedikit Nyeri", "type": "checkbox"},
                    { "id": 111169, "nama": "4 - 5= Cukup Nyeri", "type": "checkbox" },
                    { "id": 111170, "nama": "6 - 7= Lumayan Nyeri", "type": "checkbox"},
                    { "id": 111171, "nama": "8 - 9= Sangat Nyeri", "type": "checkbox"},
                    { "id": 111172, "nama": "10= Amat Sangat Nyeri", "type": "checkbox", },
                ]
            }]
            $scope.listNyeriAnak = [
                {
            ...
            $scope.listHumpty = [

                {
                    "id": 1, "nama": "Usia",
                    "detail": [
                        { "id": 111173, "nama": "< 3 tahun", "descNilai": "4" },
                        { "id": 111174, "nama": "3-7 tahun", "descNilai": "3" },
                        { "id": 111175, "nama": "8-12 tahun", "descNilai": "2" },
                        { "id": 111176, "nama": ">= 13 tahun", "descNilai": "1" },
                    ]
                },

                {
                    ...
                    "detail": [
                        { "id": 111177, "nama": "Laki-laki", "descNilai": "2" },
                        { "id": 111178, "nama": "Perempuan", "descNilai": "1" },
                    ]
                },

                {
                    "id": 3, "nama": "Diagnosis",
                    "detail": [
                        { "id": 111179, "nama": "Diagnosis Neurologi", "descNilai": "4" },
                        { "id": 111180, "nama": "Perubahan Oksigenasi (Diagnosis respiratorik, dehidrasi, anemia, anoreksia, sinkop, pusing, dsb)", "descNilai": "3" },
                        { "id": 111181, "nama": "Gangguan perilaku / psikiatri", "descNilai": "2" },
                        { "id": 111182, "nama": "Diagnosis lainnya", "descNilai": "1" },
                    ]
...

                {
                    ...
                    "detail": [
                        { "id": 111183, "nama": "Tidak menyadari keterbatasan dirinya", "descNilai": "3" },
                        { "id": 111184, "nama": "Lupa karena adanya keterbatasan", "descNilai": "2" },
                        { "id": 111185, "nama": "Orientasi baik terhadap diri sendiri", "descNilai": "1" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 111186, "nama": "Riwayat jatuh-bayi diletakan ditempat tidur dewasa", "descNilai": "4" },
                        { "id": 111187, "nama": "Pasien Menggunakan Alat bantu/bayi diletakan dalam tempat tidur bayi/perabot rumah", "descNilai": "3" },
                        { "id": 111188, "nama": "Pasien diletakan ditempat tidur", "descNilai": "2" },
                        { "id": 111189, "nama": "Area diluar rumah sakit", "descNilai": "1" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 111190, "nama": "Dalam 24 jam ", "descNilai": "3" },
                        { "id": 111191, "nama": "Dalam 48 jam", "descNilai": "2" },
                        { "id": 111192, "nama": "> 48 jam/tidak mengalami perbedaan/sedasi/anestesi", "descNilai": "1" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 111193, "nama": "penggunaan multiple, sedatif, obat hipnosis, harbiturat, fanotiazin, anti depresan, pencahar, diuretik, narkosa", "descNilai": "3" },
                        { "id": 111194, "nama": "penggunaan salah satu obat diatas", "descNilai": "2" },
                        { "id": 111195, "nama": "penggunaan medikasi lainnya atau tidak ada medikasi", "descNilai": "1" },
            ...
            $scope.$watch('item.obj[111024]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[111024] !=null && $scope.item.obj[111023]==undefined){
                          $scope.item.obj[111023] =$scope.now
                      }
                       
                    }
                })
            $scope.$watch('item.obj[111028]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[111028] !=null && $scope.item.obj[111027]==undefined){
                          $scope.item.obj[111027] =$scope.now
                      }
                       
                    }
                })
            $scope.$watch('item.obj[111032]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[1110332] !=null && $scope.item.obj[111031]==undefined){
                          $scope.item.obj[111031] =$scope.now
                      }
                       
                    }
                })
            $scope.$watch('item.obj[111036]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[111036] !=null && $scope.item.obj[111035]==undefined){
                          $scope.item.obj[111035] =$scope.now
                      }
                       
                    }
                })
            $scope.$watch('item.obj[111040]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[111040] !=null && $scope.item.obj[111039]==undefined){
                          $scope.item.obj[111039] =$scope.now
                      }
                       
                    }
                })
            $scope.$watch('item.obj[111044]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[111044] !=null && $scope.item.obj[111043]==undefined){
                          $scope.item.obj[111043] =$scope.now
                      }
                       
                    }
                })
            $scope.$watch('item.obj[111048]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[111048] !=null && $scope.item.obj[111047]==undefined){
                          $scope.item.obj[111047] =$scope.now
                      }
                       
                    }
                })
            $scope.$watch('item.obj[111052]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[111052] !=null && $scope.item.obj[111051]==undefined){
                          $scope.item.obj[111051] =$scope.now
                      }
