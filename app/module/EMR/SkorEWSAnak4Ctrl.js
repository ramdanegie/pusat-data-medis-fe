define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSAnak4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 260).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[62680] = $scope.skor1
                $scope.item.obj[62681] = $scope.skor2
                $scope.item.obj[62682] = $scope.skor3
                $scope.item.obj[62683] = $scope.skor4
                $scope.item.obj[62684] = $scope.skor5
                $scope.item.obj[62685] = $scope.skor6
                $scope.item.obj[62686] = $scope.skor7
                $scope.item.obj[62687] = $scope.skor8
                $scope.item.obj[62688] = $scope.skor9
                $scope.item.obj[62689] = $scope.skor10
                $scope.item.obj[62690] = $scope.skor11
                $scope.item.obj[62691] = $scope.skor12
