define(['initialize'], function (initialize) {
    ...
    initialize.controller('SkriningNyeriRevCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper',  'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state,  cacheHelper, medifirstService) {
            ...
            $scope.listRasaNyeri = [
                { "id": 8, "nama": "Adakah Rasa Nyeri", "detail": [{ "id": 81, "nama": "Ya    ", "descNilai": "0 ", "detail": [{ "id": 811, "nama": "Lokasi" }, 
                { "id": 812, "nama": "Frekuensi" }, { "id": 813, "nama": "Durasi" }] }, { "id": 82, "nama": "Tidak    ", "descNilai": "2 " }] }
            ]
            $scope.listTipeNyeri = [
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-data-rekam-medis', jsonSave).then(function (e) {
                    $scope.arrNyeriMempengaruhi = [];
                    $scope.getdata();
                    medifirstService.postLogging('Pengkajian Keperawatan', 'Norec Antrian Pasien Diperiksa', $state.params.noRec, 'Skrining Nyeri').then(function (res) {
                    })
                });
                // return
