define(['initialize'], function (initialize) {
    ...
    initialize.controller('RiwayatPersalinandanNipasRevCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'MedifirstService', 'DateHelper',
        function ($rootScope, $scope, ModelItem, $state, cacheHelper, medifirstService, dateHelper) {
