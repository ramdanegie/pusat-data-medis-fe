define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSAnak3Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 259).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[62471] = $scope.skor1
                $scope.item.obj[62472] = $scope.skor2
                $scope.item.obj[62473] = $scope.skor3
                $scope.item.obj[62474] = $scope.skor4
                $scope.item.obj[62475] = $scope.skor5
                $scope.item.obj[62476] = $scope.skor6
                $scope.item.obj[62477] = $scope.skor7
                $scope.item.obj[62478] = $scope.skor8
                $scope.item.obj[62479] = $scope.skor9
                $scope.item.obj[62480] = $scope.skor10
                $scope.item.obj[62481] = $scope.skor11
                $scope.item.obj[62482] = $scope.skor12
