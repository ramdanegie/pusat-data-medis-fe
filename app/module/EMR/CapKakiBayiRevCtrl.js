define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CapKakiBayiRevCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'MedifirstService', '$sce',
        function ($rootScope, $scope, ModelItem, $state, medifirstService, $sce) {
       ...
       //     debugger;
        ...
        //     })
            ...
            $scope.Save = function () {
                ...
                medifirstService.saveDataItem(tmpData, "image/upload").then(function (e) {
