define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirSbar4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            //     client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-hasilrad&id='
            //      + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true' + '&idemr=' + 435  , function (response) {
            ...
            //         $scope.listverifikasi = e.data 
            //         // $scope.item.obj[111022] = e.data[0]// { id: medifirstService.getPegawaiLogin().id, namalengkap: medifirstService.getPegawaiLogin().namaLengkap };
            //     })
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 373).then(function (e) {
           ...
           var datas = e.data.kolom4
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir SBAR 4 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
