define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('EpicECGCtrl', ['$q', '$rootScope', '$scope', 'MedifirstService', '$state', 'CacheHelper', '$window', '$location',
        function ($q, $rootScope, $scope, medifirstService, $state, cacheHelper, $window, $location) {
            ...
            function LoadDataECG(e) {
                ...
                $scope.item.customerid = e.customerid
                 medifirstService.get('emr/get-data-ecg-epic?custid=' + $scope.item.customerid + '&datesend=' + e.datesend).then(function (e) {
                    dataxml = ''
            ...
            $scope.klikKomponen = function (dataSelectedKomponen) {
                context.clearRect(-translated, 0, 1300, 600);
