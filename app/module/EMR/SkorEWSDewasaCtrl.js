define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasaCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 194).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[206437] = $scope.skor1
                $scope.item.obj[206438] = $scope.skor2
                $scope.item.obj[206439] = $scope.skor3
                $scope.item.obj[206440] = $scope.skor4
                $scope.item.obj[206441] = $scope.skor5
                $scope.item.obj[206442] = $scope.skor6
                $scope.item.obj[206443] = $scope.skor7
                $scope.item.obj[206444] = $scope.skor8
                $scope.item.obj[206445] = $scope.skor9
                $scope.item.obj[206446] = $scope.skor10
                $scope.item.obj[206447] = $scope.skor11
                $scope.item.obj[206448] = $scope.skor12
                $scope.item.obj[206449] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
