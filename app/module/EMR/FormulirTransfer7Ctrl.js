define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer7Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 331).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 401319, "nama": "IGD", "type": "checkbox" },
                        { "id": 401320, "nama": "IRJ", "type": "checkbox" },
                        { "id": 401321, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 401322, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 401349, "nama": "Ada", "type": "checkbox" },
                        { "id": 401350, "nama": "Tidak", "type": "checkbox" },
                        { "id": 401351, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 401352, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 401324, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 401325, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 401326, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 401327, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 401328, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 401329, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[401360]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
