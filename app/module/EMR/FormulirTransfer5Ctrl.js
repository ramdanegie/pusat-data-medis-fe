define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer5Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 320).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 400296, "nama": "IGD", "type": "checkbox" },
                        { "id": 400297, "nama": "IRJ", "type": "checkbox" },
                        { "id": 400298, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 400299, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 400326, "nama": "Ada", "type": "checkbox" },
                        { "id": 400327, "nama": "Tidak", "type": "checkbox" },
                        { "id": 400328, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 400329, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 400301, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 400302, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 400303, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 400304, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 400305, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 400306, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[400337]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
