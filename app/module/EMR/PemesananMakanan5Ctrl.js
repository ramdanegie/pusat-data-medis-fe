define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PemesananMakanan5Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 368).then(function (e) {
            ...
            $scope.listPesanan = [
                {
                    "id": 1, "nama": "Bentuk Makanan",
                    "detail": [
                        { "id": 405667, "nama": "1. Nasi", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 405668, "nama": "2. Nasi Tim", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 405669, "nama": "3. Bubur", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 405670, "nama": "4. Bubur Tim", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Diet Khusus"
                }
            ]
            $scope.listPesanan2 = [
                {
