define(['initialize'], function (initialize) {
    ...
    initialize.controller('AsesmenMedisRJCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listSkor = [
                { "id": 15248, "nama": "<= 10 : Rawat Inap", "descNilai": "1" },
                { "id": 15249, "nama": ">= 10 : Rawat Jalan", "descNilai": "0" },
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-asesmen-rj&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true', function (response) {
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=227").then(function (e) {
                    ...
                    for (var i = e.data.kolom2.length - 1; i >= 0; i--) {
                        if (e.data.kolom2[i].id == 15247 || e.data.kolom2[i].id == 15248 || e.data.kolom2[i].id == 15249 || e.data.kolom2[i].id == 15250)
                    ...
                    medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                        ...
                        if (cacheEMR_CTRS != undefined) {
                            ...
                            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + cacheEMR_CTRS + "&emrfk=" + 132, true).then(function (datss) {
                                ...
                                $scope.item.obj[15247]= skorsss
                                if(skorsss <= 10){
                                    $scope.item.obj[15248] = true
                                }
                                if(skorsss > 10){
                                    $scope.item.obj[15249] = true
                                }
