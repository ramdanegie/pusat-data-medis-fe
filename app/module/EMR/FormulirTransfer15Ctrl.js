define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer15Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 340).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 401663, "nama": "IGD", "type": "checkbox" },
                        { "id": 401664, "nama": "IRJ", "type": "checkbox" },
                        { "id": 401665, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 401666, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 401693, "nama": "Ada", "type": "checkbox" },
                        { "id": 401694, "nama": "Tidak", "type": "checkbox" },
                        { "id": 401695, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 401696, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 401668, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 401669, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 401670, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 401671, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 401672, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 401673, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[401704]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
