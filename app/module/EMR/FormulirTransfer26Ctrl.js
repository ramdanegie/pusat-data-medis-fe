define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer26Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 405).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109242, "nama": "IGD", "type": "checkbox" },
                        { "id": 109243, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109244, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109245, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109272, "nama": "Ada", "type": "checkbox" },
                        { "id": 109273, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109274, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109275, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109247, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109248, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109249, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109250, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109251, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109252, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109283]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
