define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransferCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 137).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 14887, "nama": "IGD", "type": "checkbox" },
                        { "id": 14888, "nama": "IRJ", "type": "checkbox" },
                        { "id": 14889, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 14890, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
