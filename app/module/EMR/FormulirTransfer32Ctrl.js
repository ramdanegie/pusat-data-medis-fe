define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer32Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 410).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109500, "nama": "IGD", "type": "checkbox" },
                        { "id": 109501, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109502, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109503, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109530, "nama": "Ada", "type": "checkbox" },
                        { "id": 109531, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109532, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109533, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109505, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109506, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109507, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109508, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109509, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109510, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109541]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
...
if (cacheEMR_TRIASE_PRIMER != undefined) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Transfer 32' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
