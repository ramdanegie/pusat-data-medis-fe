define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PengkajianEdukasiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 221).then(function (e) {
            ...
            $scope.listKebutuhanEdukasi = [
                ...
                },
                {
                    ...
                    "detail": [
                    { "id": 15061, "nama": "Mampu Menerima Informasi pada pengkajian Ulang, tgl", "type": "checkbox3"},
                        { "id": 15062, "nama": "", "type": "datetime2"},
                        { "id": 15063, "nama": "Mampu Menerima Informasi", "type": "checkbox2" },
                        { "id": 15064, "nama": "Tidak mampu Menerima Informasi", "type": "checkbox2"},
                ...
                },
                {
                    ...
                    "detail": [
                        ...
                        { "id": 15081, "nama": "Ya", "type": "checkbox2"},
            ...
            $scope.listNamaEdukasi = [
                {
                    ...
                    "detail": [
                        { "id": 15019, "nama": "", "type": "textbox" },
                        { "id": 15020, "nama": "L", "type": "checkbox" },
                        { "id": 15021, "nama": "P", "type": "checkbox" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 15023, "nama": "Pasien", "type": "checkbox" },
                        { "id": 15024, "nama": "Keluarga", "type": "checkbox" },
                        { "id": 15025, "nama": "Penanggung Jawab", "type": "checkbox" },
