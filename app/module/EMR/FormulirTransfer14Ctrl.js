define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer14Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 339).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 401620, "nama": "IGD", "type": "checkbox" },
                        { "id": 401621, "nama": "IRJ", "type": "checkbox" },
                        { "id": 401622, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 401623, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 401650, "nama": "Ada", "type": "checkbox" },
                        { "id": 401651, "nama": "Tidak", "type": "checkbox" },
                        { "id": 401652, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 401653, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 401625, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 401626, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 401627, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 401628, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 401629, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 401630, "nama": "Terapi", "type": "checkbox" },
