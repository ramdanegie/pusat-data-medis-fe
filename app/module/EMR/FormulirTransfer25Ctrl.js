define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirTransfer25Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 404).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    ...
                    "detail": [
                        { "id": 109199, "nama": "IGD", "type": "checkbox" },
                        { "id": 109200, "nama": "IRJ", "type": "checkbox" },
                        { "id": 109201, "nama": "Lain nya,", "type": "checkbox" },
                        { "id": 109202, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAdaTidak = [
                {
                    ...
                    "detail": [
                        { "id": 109229, "nama": "Ada", "type": "checkbox" },
                        { "id": 109230, "nama": "Tidak", "type": "checkbox" },
                        { "id": 109231, "nama": "Pemakaian ke :", "type": "textbox" },
                        { "id": 109232, "nama": "Tgl/Jam", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAlasanP = [
                {
                    ...
                    "detail": [
                        { "id": 109204, "nama": "PANNS EC < 15", "type": "checkbox" },
                        { "id": 109205, "nama": "PANNS EC > 15", "type": "checkbox" },
                        { "id": 109206, "nama": "Kondisi Fisik", "type": "checkbox" },
                        { "id": 109207, "nama": "Keinginan Sendiri", "type": "checkbox" },
                        { "id": 109208, "nama": "Pemeriksaan", "type": "checkbox" },
                        { "id": 109209, "nama": "Terapi", "type": "checkbox" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[109240]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
