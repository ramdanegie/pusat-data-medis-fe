define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CatatanRincianAskepCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 186).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[13101] = $scope.cc.tglregistrasi
                $scope.item.obj[13102] = {value : $scope.cc.objectkelasfk , text :$scope.cc.namakelas }
                ...
                for (var i = 0; i <= dataLoad.length - 1; i++) {
                    if (parseFloat($scope.cc.emrfk) == dataLoad[i].emrfk) {
                        ...
                        if (dataLoad[i].type == "datetime" && dataLoad[i].value != null) {
                            if(new Date(dataLoad[i].value).getFullYear() >=2018)
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Catatan Rincian Askep ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
