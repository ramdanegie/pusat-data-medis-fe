define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenFisik7Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 267).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[66363]=$scope.cc.tglregistrasi
                $scope.item.obj[66365]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
                $scope.item.obj[66364]={value: $scope.cc.objectruanganfk, text : $scope.cc.namaruangan}
                ...
                medifirstService.get("emr/get-nilai-statis-igd?noregistrasi=" + $scope.cc.noregistrasi + "&objectidawal=3037&objectidakhir=3063&idemr=124", true).then(function (datas) {
                    if (datas.data.data.length>0){
                        $scope.item.obj[66290]=datas.data.data[0].nilai
                    }
                })
            ...
            $scope.listRisikoJatuhSkor = [
                { id: 66363, nama: 'Rendah ( < 7 )' },
                { id: 66364, nama: 'Sedang ( 7 - 14 )'  },
                { id: 66365, nama: 'Tinggi ( > 14 )' },
            ]
