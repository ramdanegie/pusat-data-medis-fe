     ...
     httpServices.service('ModelItem', ['$q', '$http', '$resource', 'TextHelper', 'R',
         function($q, $http, $resource, textHelper, r) {
             ...
             return {
                     ...
                     $http({
                         ...
                         headers: {
                             ...
                             'Content-Length': Buffer.byteLength(dataVO)
                                 //'authorizationss': 'Basic ' + authorization
                         },
                 ...
                 setSkriningGiziCurrentData: function(listDataSkriningGizi, arrSkriningGizi) {
                     for (var i = 0; i < listDataSkriningGizi.length; i++) {
                 ...
                 setSkriningGiziForSend : function(masterSkriningGizi, arrSkriningGizi) {
                     var listDataSkriningGizi = [];
                     for (var i = 0; i < masterSkriningGizi.length; i++) {
