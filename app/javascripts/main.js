$(document).ready(function () {
    ...
    var UrlDataConfigPelayanan = "data/GetRequireConfigPelayanan";
    var UrlDataConfigSDM = "data/GetRequireConfigSDM";
    var UrlDataConfigSarpras = "data/GetRequireConfigSarpras";
    var UrlDataConfigManagemen = "data/GetRequireConfigManagemen";
    var UrlDataConfigKeuangan = "data/GetRequireConfigKeuangan";


    var dataConfigDefault, dataConfigPelayanan, dataConfigSDM, dataConfigSarpras, dataConfigKeuangan, dataConfigManagemen;
    //ambil data require file dari masing masing module
    $.when(
        $.getJSON(UrlDataConfig, function (data) {
            dataConfigDefault = data;
        }),
        $.getJSON(UrlDataConfigPelayanan, function (data) {
            dataConfigPelayanan = data;
        }),
        $.getJSON(UrlDataConfigSDM, function (data) {
            dataConfigSDM = data;
        }),
        $.getJSON(UrlDataConfigSarpras, function (data) {
            dataConfigSarpras = data;
        }),
        $.getJSON(UrlDataConfigManagemen, function (data) {
            dataConfigManagemen = data;
        }),
        $.getJSON(UrlDataConfigKeuangan, function (data) {
            dataConfigKeuangan = data;
        })
    ).then(function () {
        var msgError = "";
        var arrDataConfig = [dataConfigDefault, dataConfigPelayanan, dataConfigSarpras, dataConfigSDM, dataConfigManagemen, dataConfigKeuangan];
        var dataConfig = [];
